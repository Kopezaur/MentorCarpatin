...
import io.github.jhipster.application.MentorCarpatinApp;
...
public class PersonResourceIT {
    ...
    private static final Double DEFAULT_RUNNING_COEFFICIENT = 1D;
    private static final Double UPDATED_RUNNING_COEFFICIENT = 2D;
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person()
            ...
            .runningCoefficient(DEFAULT_RUNNING_COEFFICIENT)
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person()
            ...
            .runningCoefficient(UPDATED_RUNNING_COEFFICIENT)
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getHeight()).isEqualTo(DEFAULT_HEIGHT);
        assertThat(testPerson.getRunningCoefficient()).isEqualTo(DEFAULT_RUNNING_COEFFICIENT);
        assertThat(testPerson.getPerformanceCoefficient()).isEqualTo(DEFAULT_PERFORMANCE_COEFFICIENT);
    ...
    public void getAllPeople() throws Exception {
        ...
        restPersonMockMvc.perform(get("/api/people?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].runningCoefficient").value(hasItem(DEFAULT_RUNNING_COEFFICIENT.doubleValue())))
    ...
    public void getPerson() throws Exception {
        ...
        restPersonMockMvc.perform(get("/api/people/{id}", person.getId()))
            ...
            .andExpect(jsonPath("$.runningCoefficient").value(DEFAULT_RUNNING_COEFFICIENT.doubleValue()))
    ...
    public void updatePerson() throws Exception {
        ...
        assertThat(testPerson.getHeight()).isEqualTo(UPDATED_HEIGHT);
        assertThat(testPerson.getRunningCoefficient()).isEqualTo(UPDATED_RUNNING_COEFFICIENT);
        assertThat(testPerson.getPerformanceCoefficient()).isEqualTo(UPDATED_PERFORMANCE_COEFFICIENT);
